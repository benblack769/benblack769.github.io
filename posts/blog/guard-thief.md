...
But on some occasion, the guard encounters a thief that it's path never encounters, and so in 7 of the 50 simulations, the thief manages to pick up all 6 waypoints.
