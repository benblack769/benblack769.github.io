...
Code 2.0 is built ontop of Code 1.0, similarly to how Code 1.0 is built ontop of hardware. Except it is still early, think Code 1.0 in the early 90s. Which means that Code 2.0 still needs regular software developers to build the system that powers the Code 2.0 data management workflow above, help collect raw data, and build out any inference pipelines in the application. The role of the Code 2.0 developer is to be a supportive engineering role. As this was my role, I identified a few principles which helped me be effective in this position:
